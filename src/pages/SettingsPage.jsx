...
const INCOME_CATS = [
  { cat: '회비수익', part: '파트별', desc: '부원들이 정기적으로 납부하는 정기 회비 (월 1회)' },
  { cat: '사업수익', part: '공통', desc: '공연 티켓 수익, 외부 찬조금 등 고유 사업 수익' },
  { cat: '기타수익', part: '공통', desc: '통장 금융 이자 및 기타 일회성 소액 수익' },
];

const EXPENSE_CATS = [
  { cat: '임차료', part: '파트별', desc: '연습실 대여비, 무대 대관료' },
